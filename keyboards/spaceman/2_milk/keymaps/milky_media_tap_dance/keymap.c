...
void milkdrop_dance_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (milkdrop_dance_state[0].step) {
        ...
        case DOUBLE_TAP: register_code16(RGB_MODE_FORWARD); break;
        case DOUBLE_HOLD: register_code16(RGB_MODE_REVERSE); break;
...
void milkdrop_dance_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (milkdrop_dance_state[0].step) {
        ...
        case DOUBLE_TAP: unregister_code16(RGB_MODE_FORWARD); break;
        case DOUBLE_HOLD: unregister_code16(RGB_MODE_REVERSE); break;
